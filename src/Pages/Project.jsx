...
function Project() {
  return (
    <div name='Project' className="bg-white md:p-[2rem] px-4 py-8">
      <div className="flex md:flex-row flex-col gap-10 md:gap-0">
        <div className="w-full h-full space-y-12">
          ...
          <div className="md:p-4">
            <div >
              <h2 className="md:text-4xl text-xl font-bold outline-2 outline outline-gray-500 bg-[#ffe14e]">CSI-Srmcem Website</h2>
              <img src="https://i.ibb.co/bBxySPZ/csi-srmcem-web-app.png" alt="p1" className="outline-2 outline outline-gray-500" />
              <div className='outline-2 outline outline-gray-500 bg-[#ffe14e] md:text-xl'>
        ...
        <div className="w-full">
          <div className=" md:p-4 w-full h-full flex flex-col justify-center">
            <div className="">
              <h2 className="md:text-4xl text-xl font-bold outline-2 outline outline-gray-500 bg-[#ffe14e]">Portfolio</h2>
        ...
        <div className="w-full">
          <div className=" md:p-4 space-y-8 w-full h-full flex flex-col justify-center">
            <div >
              <h2 className="md:text-4xl text-xl font-bold outline-2 outline outline-gray-500 bg-[#ffe14e]">LearnWithQuiz</h2>
            ...
            <div >
              <h2 className="md:text-4xl text-xl font-bold outline-2 outline outline-gray-500 bg-[#ffe14e]">MyOnlineTodos</h2>
